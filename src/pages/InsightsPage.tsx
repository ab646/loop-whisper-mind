...
export default function InsightsPage() {
  ...
  if (!insights || insights.isEmpty) {
    ...
    return (
      <div className="h-screen mesh-gradient-bg flex flex-col overflow-hidden" style={{ paddingBottom: 'var(--bottom-nav-height)' }}>
  ...
  return (
    <div className="h-screen mesh-gradient-bg flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 scroll-container pt-6 px-5 space-y-8 relative z-10" style={{ paddingBottom: 'calc(var(--bottom-nav-height) + 24px)' }}>
