...
Return ONLY a valid JSON object:
{
  ...
  "followUpQuestions": ["3 short teaser questions that make the user curious to explore deeper. These should be intriguing hooks — things the user would WANT to tap on to learn more about themselves. They should hint at a data-backed insight without revealing it. Examples: 'How is your sleep affecting your emotional resilience?', 'What happens to this pattern on weekdays vs weekends?', 'Is there a connection between this loop and your work interactions?' Keep each under 12 words. Write them as compelling questions, not statements."],
