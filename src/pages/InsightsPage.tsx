...
export default function InsightsPage() {
  ...
  return (
    <div className="h-full min-h-0 mesh-gradient-bg flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 min-h-0 scroll-container pt-6 px-5 space-y-8 relative z-10" style={{ paddingBottom: 'calc(var(--bottom-nav-height, calc(72px + env(safe-area-inset-bottom))) + 48px)' }}>
