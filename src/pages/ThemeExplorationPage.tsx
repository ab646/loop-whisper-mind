      ...
      <div className="min-h-screen mesh-gradient-bg pb-24">
        ...
        <div className="px-5 space-y-6">
          ...
          <div className="space-y-3">
            <div className="h-7 w-3/4 rounded-lg bg-surface-container animate-pulse" />
            <div className="w-16 h-1 rounded-full bg-mint/30 animate-pulse" />
          </div>
          {/* Connected belief card */}
          <div className="rounded-2xl surface-low p-5 space-y-4 animate-pulse">
          ...
          <div className="rounded-2xl surface-low p-5 space-y-4 animate-pulse">
            <div className="flex justify-between">
              <div className="h-5 w-48 rounded bg-surface-container" />
              <div className="h-7 w-20 rounded-lg bg-surface-container" />
            </div>
            <div className="h-52 w-full rounded-lg bg-surface-container" />
          </div>
          {/* Triggers card */}
          <div className="rounded-2xl surface-low p-5 space-y-4 animate-pulse">
          ...
          <div className="rounded-2xl surface-low p-5 space-y-3 animate-pulse">
